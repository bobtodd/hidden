...
A projection operator $P$ is an operator on a vector space such that $P^2 = P$. The zero and the unit operator obviously satisfy this condition. 
\begin{displaymath}
...
\end{align*}
The eigenvalues of $\hat{A}$ are $\tfrac{1}{2}\pm |\bm{\alpha}|$, which are 0 and 1, as calculated before.

%Since $\tfrac{1}{2}+\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}$ and $\tfrac{1}{2}-\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}$ commute, using (A),
%\begin{align*}
%\langle\tfrac{1}{2}+\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}\rangle+
%\langle\tfrac{1}{2}-\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}\rangle
%=\langle\tfrac{1}{2}+\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}+\tfrac{1}{2}%-\tfrac{1}{2}\hat{\bm{\alpha}}\cdot\bm{\sigma}\rangle =1.
%\end{align*}
