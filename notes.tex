...
and we have \todo{I think you're right that my argument here is wrong. But your calculation is not $\langle \alpha \mathbbm{1} + \bm{\beta} \cdot \bm{\sigma} \rangle$, but rather the $\langle \alpha \mathbbm{1} + \bm{\beta} \cdot \bm{\sigma} \rangle_{\psi}$ that I calculate below.}
\begin{displaymath}
  \langle \alpha \mathbbm{1} + \bm{\beta} \cdot \bm{\sigma} \rangle
